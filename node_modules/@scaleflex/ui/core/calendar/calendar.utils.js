...
export var getMinDate = function getMinDate(minDate) {
  return {
    ...
    minDateTimestamp: new Date("".concat(minDate, "T00:00:00")).getTime()
  };
};
...
export var getMaxMinSelectedDay = function getMaxMinSelectedDay(maxDate, minDate, monthDetails, maxDay, minDay, autoSelectToday) {
