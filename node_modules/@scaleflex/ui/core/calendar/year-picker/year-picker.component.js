...
var YearPicker = intrinsicComponent(function (_ref, ref) {
  ...
  var handleOnClickYear = function handleOnClickYear(year) {
    ...
    setYear === null || setYear === void 0 || setYear(year);
    setShowYearsDatePicker === null || setShowYearsDatePicker === void 0 || setShowYearsDatePicker(false);
    setMonthDetails === null || setMonthDetails === void 0 || setMonthDetails(getMonthDetails === null || getMonthDetails === void 0 ? void 0 : getMonthDetails(year, monthIndex));
  };
  useEffect(function () {
  ...
  useEffect(function () {
    if (maxDate && isYearForm && _maxMonth && !value) {
      ...
      setEndYear(maxYear);
      setYear === null || setYear === void 0 || setYear(maxYear);
