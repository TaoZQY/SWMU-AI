...
var MonthPicker = intrinsicComponent(function (_ref, ref) {
  ...
  useEffect(function () {
    if (getTimeStamp && enableAutoSelect) setSelectedDay === null || setSelectedDay === void 0 || setSelectedDay(getTimeStamp());
  }, [monthDetails]);
  var handleOnClickMonth = function handleOnClickMonth(index) {
    setSelectedMonth === null || setSelectedMonth === void 0 || setSelectedMonth(getMonthStr === null || getMonthStr === void 0 ? void 0 : getMonthStr(index));
    setMonth === null || setMonth === void 0 || setMonth(index);
    setShowMonthsDatePicker === null || setShowMonthsDatePicker === void 0 || setShowMonthsDatePicker(false);
    setMonthDetails === null || setMonthDetails === void 0 || setMonthDetails(getMonthDetails === null || getMonthDetails === void 0 ? void 0 : getMonthDetails(year, index));
  ...
  useEffect(function () {
    if (maxDate && maxMonth && isMonthValid && !value) {
      setMonth === null || setMonth === void 0 || setMonth(maxMonth);
      setMonthDetails === null || setMonthDetails === void 0 || setMonthDetails(getMonthDetails === null || getMonthDetails === void 0 ? void 0 : getMonthDetails(maxYear, maxMonth));
    }
  }, []);
