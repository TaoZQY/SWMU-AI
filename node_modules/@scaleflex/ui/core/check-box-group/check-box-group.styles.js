...
var Label = /*#__PURE__*/styled.span.attrs({
  ...
  return css(["display:inline-block;align-items:center;", " ", ":4px;color:", ";cursor:", ";white-space:nowrap;text-overflow:ellipsis;overflow:hidden;"], sizeCheckboxGroupMixin[size], "margin-".concat(labelPosition === 'after' ? 'left' : 'right'), disabled ? theme.palette[PColor.ButtonDisabledText] : theme.palette[PColor.TextPrimary], disabled ? 'default' : 'pointer');
});
